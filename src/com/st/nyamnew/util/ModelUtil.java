...
public class ModelUtil {
	...
	public static Profile getProfileFromJSON(JSONObject object) throws JSONException {
		...
		String impPath = object.getString("avatar").replace("http://nyam.ru/", "");
		Log.d(TAG, "img_path = " + impPath);
		profile.setImg_path(impPath);
	...
	public static RecipeGeneral getRecipeGeneralFromJSON(JSONObject object)
		...
		String imgUrl = object.getString("img_url").replace("http://nyam.ru/", "");
		Log.d(TAG, "img_url = " + imgUrl);
		recipe.setImg_url(imgUrl);
	...
	public static Step getStepFromJSON(JSONObject object) throws JSONException {
		...
		String img = object.getString("img_url").replace("http://nyam.ru/", "");
		Log.d(TAG, "img = " + img);
