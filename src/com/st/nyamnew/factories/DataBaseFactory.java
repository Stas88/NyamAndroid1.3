package com.st.nyamnew.factories;
...
import com.st.nyamnew.util.ModelUtil;
import com.st.nyamnew.util.SD_util;
...
public class DataBaseFactory   {
	...
	private static String DB_PATH = "/data/data/com.st.nyamnew/databases/";
